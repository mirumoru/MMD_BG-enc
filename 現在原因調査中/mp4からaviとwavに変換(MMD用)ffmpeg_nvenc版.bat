@echo off
rem ==========================================================================================
rem 作成：みるもるの家 更新:2023年3月05日 『mp4からMMDの背景で読み込めるaviに変換するバッチ』v1.4.2
...
ffmpeg -i %INPUT_FOLDER%\%%i -r 30 -vf fps=30000/1001 -vcodec h264_nvenc -preset lossless -an -g 150 %OUTPUT_FOLDER%%%x_MMD用FFNV版.avi
echo %%iの動画処理が完了しました。
